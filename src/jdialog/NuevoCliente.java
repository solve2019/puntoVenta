...
public class NuevoCliente extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(txtnombre.getText().trim().equals("")){
            ...
            conex con=new conex();  
            try {
                String myQuery = "insert into tc_clientes (nombre_completo,telefono,rfc,email,puntos,codigo_barras,calle,colonia,noext,cp,municipio,estado,razon_social,pais,ciudad,no_interior,MetodoPago,FormaPago,noCuenta,dias_credito,categoria) "
                + "values('"+txtnombre.getText().trim()+"','"+txttelefono.getText().trim()+"','"+txtrfc.getText().trim()+"','"+txtcorreo.getText().trim()+"',0,'"+barcodecliente+"','"+txtcalle.getText().trim()+"','"+txtcolonia.getText().trim()+"','"+txtnoext.getText().trim()+"','"+txtcp.getText().trim()+"','"+txtmunicipio.getText().trim()+"','"+txtestado.getText().trim()+"','"+txtrazonsocial.getText().trim()+"','"+txtpais.getText().trim()+"','"+txtciudad.getText().trim()+"','"+txtnoint.getText().trim()+"','"+txtmetodopago.getText().trim()+"','PAGO EN UNA SOLA EXHIBICION','"+txtnocuenta.getText().trim()+"','"+txtdiascredito.getText().trim()+"','"+jccategoria.getSelectedItem().toString()+"')";
