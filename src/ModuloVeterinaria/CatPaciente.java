...
public static String idcliente="";
    ...
    private void initComponents() {
        ...
        jtpacientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Sucursal", "Fecha Reg.", "Direccion", "Estado", "Contacto", "Observacion", "Telefono", "Referencia Domicio"
            }
        ) {
        ...
        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/rep.png"))); // NOI18N
        jButton1.setText("Alta sucursal");
        ...
        jButton4.setText("Generar servicio");
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        // TODO add your handling code here:
            ...
            if(fila!=-1){
                String id=jtpacientes.getValueAt(jtpacientes.getSelectedRow(),0).toString();   
                Frame f = JOptionPane.getFrameForComponent(this);
                Estetica este=new Estetica(f,true,id,"0");
                este.show();
                System.out.println("Se ha hecho doble click");
            }else{
                JOptionPane.showMessageDialog(null,"Seleccione una sucursal de la Tabla","Alerta",JOptionPane.ERROR_MESSAGE);
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        int fila=-1;
            ...
            if(fila!=-1){
                ...
                dialogButton=JOptionPane.showConfirmDialog (null, " Desea eliminar la sucursal?","Entrega de Mascota",dialogButton);
                if(dialogButton == JOptionPane.YES_OPTION){ //The ISSUE is here
                    String id=jtpacientes.getValueAt(jtpacientes.getSelectedRow(),0).toString();   
                    conex con=new conex();      
                    String myQuery = "update tc_mascotas set estatus=0 where Idmascota="+id;
                   ...
                   try {
                       ...
                       JOptionPane.showMessageDialog(null, "Error al eliminar la sucursal: "+ex, "Error", JOptionPane.ERROR_MESSAGE);
                   }
                }
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
        ...
        int fila=-1;
            ...
            if(fila!=-1){
                String id=jtpacientes.getValueAt(jtpacientes.getSelectedRow(),0).toString();   
                Frame f = JOptionPane.getFrameForComponent(this);
                EditSucursal editsuc=new EditSucursal(f,true,id);
                editsuc.show();
...
public static void cargartabla(){    
        ...
        conex con=new conex();   
        ResultSet rsR = null;        
        String myQuery = "select * from tc_mascotas where estatus=1 and idrcliente="+idcliente;
               //System.out.println(""+myQuery);
               try {
                   Statement st = con.getConnection().createStatement();
                   rsR = st.executeQuery(myQuery);
                   while(rsR.next()) {                                                
                            modelo.addRow(new Object[]{rsR.getString("Idmascota"),rsR.getString("nombrepaciente"),rsR.getString("fecha_nacimiento"),rsR.getString("raza"),rsR.getString("sexo"),rsR.getString("color"),rsR.getString("observaciones"),rsR.getString("telefono"),rsR.getString("referencia")});                        
                   }
