...
String idclientes="";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(nombre.equals("")){
            ...
            JOptionPane.showMessageDialog(null, "Error falta seleccionar la fecha de registro. ", "Error", JOptionPane.ERROR_MESSAGE);
        }else{
            conex con=new conex();               
            String myQuery = "insert into tc_mascotas (nombrepaciente,fecha_nacimiento,raza,sexo,color,observaciones,idrcliente,telefono,referencia,donde_se_entero,categoria_sucursal) values(UPPER('"+nombre+"'),'"+fechafin+"',UPPER('"+raza+"'),'"+sexo+"',UPPER('"+color+"'),UPPER('"+observaciones+"'),'"+idclientes+"','"+telefono+"','"+referencia+"','"+medio+"','"+cate+"')";
               ...
               try {
                   ...
                   st.close();
                   con.desconectar();                  
                   JOptionPane.showMessageDialog(null, "Se registro la sucursal correctamente.", "Ok", JOptionPane.INFORMATION_MESSAGE);
                   dispose();
