...
public boolean facturarventa(String codigobarras,String tipopagofactura){
    boolean exito=true;
    ...
    String JDBC_DRIVER = "com.mysql.jdbc.Driver";  
       ...
       String DB_URL = "jdbc:mysql://"+ip+"/"+conex.bd;
        ...
        try{
           ...
           double sumatoria=Double.parseDouble(subtotal)+Double.parseDouble(iva)+Double.parseDouble(descuento);
           ...
           double ivass=(float) (subt*paramiva);
           ...
           SQL="insert into to_facturas (idr_cliente,noCuenta,MetodoPago,FormaPagos,cantidad,unidad,concepto,subtotal,iva, Monto, factura, FechaGeneracion,folio,descuento,ieps) values ('"+idcliente+"','"+nocuenta+"','"+MetodoPago+"','"+formapago+"','"+cantidad+"','PZA','"+concepto+"','"+subtotal+"','"+iva+"','"+total+"','"+factura_nueva+"',now(),'"+no_folio+"','"+descuento+"',"+ieps+")";
           System.out.println(""+SQL);
           ...
           factura.generarfactura(Integer.parseInt(idcliente),patharchivos,factura_nueva,email,cliente,tipopagofactura);
