...
public class EdicionFidelizacion extends javax.swing.JDialog {
    ...
    public EdicionFidelizacion(java.awt.Frame parent, boolean modal,String id) {
        ...
        ids=id;
            ...
            String myQuery = "select * from tc_clientes where Idcliente="+ids;
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(nombre.equals("")){
            ...
            conexremoto con=new conexremoto();               
            String myQuery = "update tc_clientes set nombre=UPPER('"+nombre+"'), direccion='"+direccion+"', telefono='"+tel+"', correo='"+correo+"', codigobarras='"+codbar+"' where Idcliente="+ids;
               System.out.println(""+myQuery);
               try {
                   Statement st = con.getConnection().createStatement();
