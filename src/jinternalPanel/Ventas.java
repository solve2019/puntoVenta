        ...
        // TODO add your handling code here:
         ...
         if (evt.getClickCount() == 2) {
             ...
             if(val==false){
                ...
                Frame f = JOptionPane.getFrameForComponent(this);
                EditarCantidad dialog = new EditarCantidad(f,true,fila,producto,cantidad,precio,existencia,idprod);
                dialog.show();
             }
         }
...
public void cobrar_venta(){
    ...
    if(numprod>0){
        ...
        for(int fila=0; fila<jtproductos.getRowCount(); fila++){
               ...
               productos.add(jtproductos.getValueAt(fila, 6).toString()+"@"+jtproductos.getValueAt(fila, 0).toString()+"@"+jtproductos.getValueAt(fila, 2).toString()+"@"+jtproductos.getValueAt(fila, 3).toString()+"@"+jtproductos.getValueAt(fila, 4).toString()+"@"+jtproductos.getValueAt(fila, 1).toString()+"@"+jtproductos.getValueAt(fila, 8).toString());               
       }
        ...
        Cobrar_venta venta=new Cobrar_venta(f,true,monto_final,productos,subtotal,cliente,ieps);
        venta.show();
    }else{
