...
private static TableRowSorter<TableModel> sorter;
    ...
    private void initComponents() {
        ...
        jtproductos = new javax.swing.JTable(){
            public boolean isCellEditable(int rowIndex, int colIndex) {
                if(colIndex==12){ //Con esto se pueden editar todas las celdas menos la de la columna 0  colIndex==7 ||
                    return true;
                }
                else{
                    return false;
        ...
        jtproductos.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Código de Barras", "Producto", "Precio de Compra", "Precio de Venta", "Existencia", "Min Stock", "Categoria", "Precio Mayoreo", "Min Mayoreo", "Prod Comp", "Unidad", "Imprimir"
            }
        ) {
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        ...
        TiketPDF etiqueta=new TiketPDF();
         for(int fila=0; fila<jtproductos.getRowCount(); fila++){               
               if(jtproductos.getValueAt(fila, 11)==null){
               }else{
    ...
    public static String cargarcate(String idcate, conex con){
        String categoria="";
        if(idcate==null){
        }else{
    ...
    public static void cargartabla(){    
        ...
        if(buscar.equals("")){
            ...
            sqlaux=sqlaux+" and (nombre_producto like '%"+buscar+"%' or codigo_barras like '%"+buscar+"%')";
        }
        String myQuery = "select * from tc_productos where estatus=1"+sqlaux+" limit 100";
               //System.out.println(""+myQuery);
               try {
                   Statement st = con.getConnection().createStatement();
                   rsR = st.executeQuery(myQuery);
                   while(rsR.next()) {  
                            String categoria=cargarcate(rsR.getString("idrcategoria"),con);
                            modelo.addRow(new Object[]{rsR.getString("idproducto"),rsR.getString("codigo_barras"),rsR.getString("nombre_producto"),rsR.getString("precio_compra"),rsR.getString("precio_venta"),rsR.getString("existencia"),rsR.getString("cantidad_minima"),categoria,rsR.getString("precio_mayoreo"),rsR.getString("cantidad_mayoreo"),rsR.getString("prodcompuesto"),rsR.getString("unidad")});                        
                   }
