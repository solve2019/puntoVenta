...
private static TableRowSorter<TableModel> sorter;
    ...
    public Clientes() {
        ...
        jtclientes.getColumnModel().getColumn(1).setWidth(100);
        ...
        jtclientes.getColumnModel().getColumn(2).setWidth(100);
        
        jtclientes.getColumnModel().getColumn(3).setMaxWidth(120);
        jtclientes.getColumnModel().getColumn(3).setMinWidth(120);
        jtclientes.getColumnModel().getColumn(3).setPreferredWidth(120);
        jtclientes.getColumnModel().getColumn(3).setWidth(120);
        
        jtclientes.getColumnModel().getColumn(4).setMaxWidth(180);
        jtclientes.getColumnModel().getColumn(4).setMinWidth(180);
        jtclientes.getColumnModel().getColumn(4).setPreferredWidth(180);
        jtclientes.getColumnModel().getColumn(4).setWidth(180);
        
        jtclientes.getColumnModel().getColumn(5).setMaxWidth(100);
        jtclientes.getColumnModel().getColumn(5).setMinWidth(100);
        jtclientes.getColumnModel().getColumn(5).setPreferredWidth(100);
        jtclientes.getColumnModel().getColumn(5).setWidth(100);
    }
    ...
    private void initComponents() {
        ...
        jtclientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Cliente", "Teléfono", "RFC", "Correo", "No. Cliente", "Contacto", "Direccion", "Categoria"
            }
        ) {
        ...
        jButton6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/Icono_libro.png"))); // NOI18N
        jButton6.setText("Generar Cotizacón");
    ...
    private void filtrar() {
        ...
        try {
            rf = RowFilter.regexFilter("(?i)"+txtBusqueda.getText(),1,2,3,4,5,6);
...
public static void cargartabla(){    
        ...
        String myQuery = "select * from tc_clientes where estatus=1";
               ...
               try {
                   ...
                   while(rsR.next()) {                                                
                            modelo.addRow(new Object[]{rsR.getString("idcliente"),rsR.getString("nombre_completo"),rsR.getString("telefono"),rsR.getString("rfc"),rsR.getString("email"),rsR.getString("codigo_barras"),rsR.getString("razon_social"),rsR.getString("calle")+" #"+rsR.getString("noext")+" Col. "+rsR.getString("colonia")+" "+rsR.getString("municipio")+" "+rsR.getString("estado"),rsR.getString("categoria")});                        
                   }
